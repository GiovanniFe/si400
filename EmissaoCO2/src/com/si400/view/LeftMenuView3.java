...
public class LeftMenuView3 implements LeftMenuView {
    ...
    private final ChoiceBox cbCountry1, cbCountry2, cbYear;
    ...
    private void setLayoutLeft() {
        ...
        Utils.setCbStyle(cbCountry1, cbCountry2, cbYear);
        GridPane.setConstraints(lblFilters, 0, 0);
        GridPane.setConstraints(lblCountry1, 0, 1);
        GridPane.setConstraints(cbCountry1, 0, 2);
        GridPane.setConstraints(lblCountry2, 0, 3);
        GridPane.setConstraints(cbCountry2, 0, 4);
        ...
        layoutLeft = Utils.getGpLayout(Dimensions.getW_LEFT2(), Dimensions.getH_SIDE(), 15, Pos.TOP_CENTER,
                lblFilters, lblCountry1, lblCountry2, lblYear, cbCountry1, cbCountry2, cbYear, btnGenerate);
    ...
    public ChoiceBox getCbCountry2() {
        return cbCountry2;
    }
